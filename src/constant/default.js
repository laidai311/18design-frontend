export const COPYRIGHT = `Copyright ${new Date().getFullYear()} © 18Design - 083.8586.444`;
export const COLOR_LOGO_URL = "./images/18-design-cut.png";
...
export const PHONE = "083.8586.444";
