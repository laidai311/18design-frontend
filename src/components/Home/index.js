...
import { Container, ImageDefault } from "../styled";
          ...
          <Col6>
            <div>
              <div class="text-action">
                <ImageDefault src="https://noithatdreamhome.vn/wp-content/uploads/2022/07/banner_ngang_aeros3.webp" />
              </div>
            </div>
          </Col6>
        </Row>
        ...
        <Our>
          ...
          <Container>
            <div className="Our__Title">
              ...
              <OurTextItalic>
                Với slogan &#34;KIẾN TRÚC KHÁC BIỆT - KHÔNG GIAN ĐẶC BIỆT&#34;, chúng tôi đề cao sáng tạo, đổi mới và cung cấp ý tưởng thiết kế tạo ra những không gian sống ý nghĩa, mang dấu ấn cá
                nhân, xứng tầm với phong cách,
                <br />
                tầm nhìn của mọi gia chủ bằng tâm huyết, bằng kinh nghiệm, sự nhiệt tình và sáng tạo của đổi ngũ <CompanyTitle> 18 design</CompanyTitle>
              </OurTextItalic>
            </div>
            <OurInfo>
              <OurItem>
              ...
              <OurItemCenter>
                <OurBlock>
                  ...
                  <OurDescription>
                    Chúng tôi cam kết mang đến sự sáng tạo thông qua thiết kế và thi công, nâng cao không gian sống của bạn thành tuyệt vời hơn. Mục tiêu của chúng tôi là cung cấp tổ ấm chất lượng,
                    cao cấp, và đầy giá trị, thể hiện tình yêu và trách nhiệm đối với cuộc sống và xã hội.
                  </OurDescription>
                </OurBlock>
