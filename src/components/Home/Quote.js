    ...
    return (
        <section>
            <div className="flex flex-col lg:flex-row items-stretch">
                <div className="flex-1 bg-[#949599] text-white h-full flex items-center justify-center py-20 px-3">
                    <h3 className="text-center uppercase flex flex-col space-y-1.5">
                        <span className="text-sm">
                            Bạn đang ấp ủ ý tưởng về ngôi nhà của mình?
                        </span>
                        <span className="text-3xl">Hãy liên lạc ngay</span>
                        <span className="text-sm">
                ...
                <div
                    className="flex-1 flex items-center justify-center py-20 px-3 text-white"
                    style={{
