                ...
                <Container>
                    <div className="Our__Title">
                        ...
                        <OurTextItalic>
                            ...
                            cung cấp ý tưởng thiết kế <br /> ra những không gian
                            sống ý nghĩa, mang dấu ấn cá nhân, xứng tầm với
                            phong cách, tầm nhìn của mọi gia chủ bằng tâm huyết,
                            bằng kinh nghiệm, sự nhiệt tình và sáng tạo của đổi
                            ngũ <CompanyTitle> 18 design</CompanyTitle>
                        </OurTextItalic>
                    </div>
                    <OurInfo>
                        <OurItem>
                            <OurBlock>
                                <ImageOur className="flex justify-center mb-3">
                                    <Image
                                        alt="icon"
                                        src="https://noithatdreamhome.vn/wp-content/uploads/2022/07/icon-3.png"
                                    />
                                </ImageOur>
                        ...
                        <OurItemCenter>
                            <OurBlock>
                                <ImageOur className="flex justify-center mb-3">
                                    <Image
                                        alt="icon"
                                        src="https://noithatdreamhome.vn/wp-content/uploads/2022/07/icon-2.png"
                                    />
                                </ImageOur>
                                <OurDescription>
                        ...
                        <OurItem>
                            <OurBlock>
                                <ImageOur className="flex justify-center mb-3">
                                    <Image
                                        alt="icon"
                                        src="https://noithatdreamhome.vn/wp-content/uploads/2022/07/icon-1.png"
                                    />
                                </ImageOur>
                                <OurTitleSecond>
...
export function Introduct() {
    return (
        <Introduction className="pt-8 relative text-white">
            <div className="container max-w-7xl mx-auto">
                ...
                <div className="relative -mx-4 flex flex-wrap">
                    <div className="w-full p-4 md:w-1/2 lg:w-1/3 space-y-3">
                        ...
                        <div className="text-center space-y-1">
                            <h3 className="text-primary uppercase font-semibold">
                                đội ngũ thiết kế kinh nghiệm
                            </h3>
                            <p className="">
                                Đội ngũ kiến trúc sư có kinh nghiệm lâu năm với
                                tư duy sáng tạo
                            </p>
                        </div>
                    </div>
                    <div className="w-full p-4 md:w-1/2 lg:w-1/3">
                        ...
                        <IntroductInfo>
                            <IntroductItemTitle>
                                ĐỘI NGŨ GIÁM SÁT NĂNG LỰC CAO
                            </IntroductItemTitle>
                            <IntroductDescription>
                                Đội ngũ tư vấn giám sát năng lực cao và tinh
                                thần làm việc nhiệt huyết!
                            </IntroductDescription>
                        </IntroductInfo>
                    </div>
                    <div className="w-full p-4 md:w-1/2 lg:w-1/3">
                        ...
                        <IntroductInfo>
                            ...
                            <IntroductDescription>
                                Đội ngũ công nhân đều có tay nghề cao, đã tham
                                gia nhiều dự án.
                            </IntroductDescription>
                        </IntroductInfo>
                    </div>
                    <div className="w-full p-4 md:w-1/2 lg:w-1/3">
                        ...
                        <IntroductInfo>
                            ...
                            <IntroductDescription>
                                Xưởng sản xuất với cơ sở vật chất hiện đại cho
                                sản phẩm tốt nhất.
                            </IntroductDescription>
                        </IntroductInfo>
                    </div>
                    <div className="w-full p-4 md:w-1/2 lg:w-1/3">
                        ...
                        <IntroductInfo>
                            ...
                            <IntroductDescription>
                                Bảng giá của các sản phẩm và dịch vụ cung cấp
                                cạnh tranh.
                            </IntroductDescription>
                        </IntroductInfo>
                    </div>
                    <div className="w-full p-4 md:w-1/2 lg:w-1/3">
                        ...
                        <IntroductInfo>
                            ...
                            <IntroductDescription>
                                Cam kết hỗ trợ khách hàng mọi vấn đề về bảo
                                hành, bảo trì sản phẩm trong 05 năm sử dụng
                            </IntroductDescription>
                        </IntroductInfo>
                    </div>
                </div>
