...
function Comment() {
  ...
  const validateField = (fieldName, value, regex, errorMessage) => {
    if (!regex.test(value)) {
      ...
      setErrorMessages((prevErrors) => ({ ...prevErrors, [fieldName]: undefined }));
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const hasErrors = Object.values(errorMessages).some((errorMessage) => errorMessage !== undefined);
      ...
      <div className="flex flex-col space-y-4">
        <div className="bg-white p-4 rounded-lg shadow-md">
          ...
          <p className="text-gray-700">
            This is a sample comment. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
            magna aliqua.
          </p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-md">
          ...
          <p className="text-gray-700">
            I agree with John. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
            aliqua.
          </p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-md">
          ...
          <p className="text-gray-700">
            I have a different opinion. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
            magna aliqua.
          </p>
        </div>
        <form className="bg-white p-4 rounded-lg shadow-md" onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            ></textarea>
            {errorMessages.comment && <p className="text-red-500">{errorMessages.comment}</p>}
          </div>
          <button className="bg-yellow-600 hover:bg-cyan-700 text-white font-bold py-2 px-4  focus:outline-none focus:shadow-outline" type="submit">
            Phản hồi
          </button>
        </form>
      </div>
