      ...
      <Container>
        <ContactBlock>
          <ContactTitle>
            ...
            <p>
              Công Ty Cổ Phần Kiến Trúc Và Đầu Tư Xây Dựng 18 Design là một trong những công ty hàng đầu về thiết kế và thi công kiến trúc - nội ngoại thất, từng bước trở thành Nhà thiết kế và thi
              công kiến trúc – nội ngoại thất, được các công ty RIKI Việt Nam, Truyền Thông Đậu Family, Imago Work hay tập đoàn Tài Tâm lựa chọn làm đối tác chiến lược. <strong>18 Design</strong> ghi
              dấu ấn thiết kế nội thất sang trọng, thi công nội thất cao cấp trên các dự án: Vinhomes Timecity Park Hill, Vinhomes Royal City, Vinhomes Smartcity, One 18 Ngọc Lâm, Vinhomes D’capitale,
              Shophouse 124 Vĩnh Tuy, Lake View,...
            </p>
          </ContactTitle>
          <ContactSocial>
            <ContactSocialItem>
            ...
            <ContactSocialItem>
              ...
              <ContactDescription>
                <h4>Địa chỉ</h4>
                <p>Số 1, Nguyễn Cảnh Dị, Đại Kim, Hoàng Mai, TP. Hà Nội</p>
              </ContactDescription>
            </ContactSocialItem>
            <ContactSocialItem>
              <ContactIcon>
