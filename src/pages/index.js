...
export const getStaticProps = async (context) => {
  ...
  const our_partner_images = homePageData?.meta_box?.our_partner_images?.length
  ...
  const meta_box = {
    ...
    seo: {
      ...
      seo_title_template: homePageData?.meta_box?.seo_title_template || "",
      ...
      seo_openGraph_title: homePageData?.meta_box?.seo_openGraph_title || "",
      ...
      seo_twitter_handle: homePageData?.meta_box?.seo_twitter_handle || "",
      seo_twitter_site: homePageData?.meta_box?.seo_twitter_site || "",
      seo_twitter_cardType: homePageData?.meta_box?.seo_twitter_cardType || "",
    },
  };
